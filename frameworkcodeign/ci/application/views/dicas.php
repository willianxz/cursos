...
<html>
    ...
    <ul class="w3-navbar w3-red w3-card-2 w3-top w3-left-align w3-large">
      ...
      <li class="w3-hide-small"><a href="http://localhost/frameworkcodeign/ci/dicas" class="w3-padding-large w3-white">Dicas</a></li>
    ...
    <div class="w3-container w3-red w3-center w3-padding-128">
      <h1 class="w3-margin w3-jumbo">Dicas</h1>
    </div>
...
<div class="w3-row-padding w3-content" style="max-width:1400px">
  <div class="w3-twothird">
     ...
     <img src="<?php echo base_url('images/cafe1.jpg'); ?>" alt="Café" style="width:100%"/> 
