 <!-- Navbar -->
    <ul class="w3-navbar w3-red w3-card-2 w3-top w3-left-align w3-large">
      ...
      <li><a href="http://localhost/frameworkcodeign/ci3/site" class="w3-padding-large w3-white">Home</a></li>
      ...
      <li class="w3-hide-small"><a href="http://localhost/frameworkcodeign/ci3/site/faleconosco" class="w3-padding-large w3-hover-white">Fale Conosco</a></li>
    </ul>
    ...
    <div class="w3-container w3-red w3-center w3-padding-128">
      <h1 class="w3-margin w3-jumbo">Seja Bem vindo!</h1>
    </div>
