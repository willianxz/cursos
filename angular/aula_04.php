       ...
       <div ng-app="">
           ...
           <div class="w3-container w3-center">
             ...
             <select class="w3-select w3-border" ng-model="estilo" >
              ...
              <h1> Escolha o link da imagem: </h1>
             <select class="w3-select w3-border" ng-model="link" >
                 <option value="www.google.com" disabled selected>Escolha o link</option>
                ...
                <div class="w3-container">
                    <div class="w3-row">
                        <div class="w3-col m5">
                            <a href="{{link}}"><img src="img/{{imagem}}.png" class="{{estilo}}" style="width: 100%;"/></a>
                        </div>
                    </div>
               </div>
           </div>
